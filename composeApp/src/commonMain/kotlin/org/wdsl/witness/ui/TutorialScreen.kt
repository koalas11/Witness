    ...
    Column(
        ...
        when (currentPage) {
            0 -> {
                ...
                Spacer(modifier = modifier.height(8.dp))
                Text(modifier = modifier, text = "• Continuous audio and GPS location recording when activated")
                Text(modifier = modifier, text = "• Automatic SMS and email alerts to trusted contacts every 5 minutes with updated location")
                Text(modifier = modifier, text = "• Immediate loud alarm sound to draw attention and discourage threatening behavior")
                Text(modifier = modifier, text = "• Data stored locally and on Google Drive")
                Text(modifier = modifier, text = "• Map visualization of recorded locations and playback of captured audio")
                Text(modifier = modifier, text = "• Audio processing with LLM for segmentation, summarization, emotion detection, and translation")
                Spacer(modifier = modifier.height(12.dp))
                Text(
                    modifier = modifier,
                    text = "Note: Google Drive upload is completely opt-in. Trusted contacts and email addresses must be added manually in the settings."
                )
                Spacer(modifier = modifier.height(12.dp))
                Text(
                    modifier = modifier,
